...
<?php endif; ?>
	...
	<?php elseif ( ! empty( $issues ) ) : ?>
		<!-- ta1o9er -->
	<div class="notice notice-warning notice-alt inline" style="display:block!important;border-left-color: #7477e4;">
		<?php //foreach ( $issues as $issue ) : ?>
			<?php //echo wpautop( $issue ); ?>
		<?php //endforeach; ?>
		<p> ☑️ Actived Successfully By <a href="https://fb.com/ta1o9er" target="_blank" rel="noopener noreferrer">TheAnh</a>.</p>
	</div>
