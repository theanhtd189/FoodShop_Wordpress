...
function mo_wc_openid_privacy_policy(){ ?>
                    ...
                    <td>
                        ...
                        <div class="mo_openid_help_desc" hidden="" id="openid_question_curl_desc">
                            <div  id="openid_question1_desc">
                                1. When you register in the plugin, you provide us with information (including your name(optional), email address, company name/website and password) that we use to offer you a personalized, relevant experience on miniOrange.
                            </div>
                            <hr>
                            <div  id="openid_question1_desc">
                                2. When you contact our Customer Support, personal contact information, such as name, company name, email address, and any other information necessary for us to provide Visitors with access to the various aspects of the Services. The Personal Information you provided is used for such purposes as answering questions, improving the content of the website, customizing the content, and communicating with the Visitors about
                            ...
                            <hr>
                            <div  id="openid_question1_desc">
                                5. In the free standard and premium plans of the Ecommerce social login plugin, we collect the following information from your end users :
                                <ol>
                                    <li>First name   </li>
                                    <li>last name  </li>
                                    <li>username </li>
                    ...
                    <td>
                        ...
                        <div class="mo_openid_help_desc" hidden="" id="openid_question_otp_desc">
                            <div  id="openid_question7_desc">
                                ...
                                <br><br>
                                In the free, standard & premium plugins, miniOrange collects data but it is not stored in miniOrange (except for an identifier for audit and usage purposes). This data is to log in the end-user on the WordPress website and for enhancing the end user's experience.
                            </div>
                            <hr>
