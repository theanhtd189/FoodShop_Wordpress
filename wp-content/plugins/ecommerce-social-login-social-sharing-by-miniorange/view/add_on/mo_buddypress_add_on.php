...
{ ?>
    <div id="bp_addon_head" style="display: block">
        <table>
            <tr>
                <td >
                    <h3><?php echo mo_wc_sl('Buddypress Add-on');?>
                    ...
                    <b><?php echo mo_wc_sl('Buddypress add-on provides you both buddypress display option and buddypress extended attribute mapping.&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;');?></b>
                </td>
            </tr>
        </table>
    ...
    <div class="mo_openid_highlight">
        <h3 style="margin-left: 2%;line-height: 210%;color: white;"><?php echo mo_wc_sl('BuddyPress / BuddyBoss Display Option');?></h3>
    </div>
    ...
    <form id="wa_display" name="wa_display" method="post" action="">
            <div class="mo_openid_wca_table_layout_fake" style="height: 550px"><br/>
                <div style="width:40%; background:white; float:left; border: 1px transparent; margin-left: 25px">
                    <label style="padding-left: 0px;" class="mo_openid_checkbox_container_disable">
                        ...
                        <div style="padding-left: 7%">
                            <?php echo mo_wc_sl("Before registration form");?>
                        </div>
                    ...
                    <label style="padding-left: 0px;" class="mo_openid_checkbox_container_disable">
                        ...
                        <?php echo mo_wc_sl("Before Account Details");?>
                        </div>
                ...
                <div style="width:50%; background:white; float:right; border: 1px transparent;">
                    <label style="padding-left: 0px;" class="mo_openid_checkbox_container_disable">
                        <div style="padding-left: 7%">
                        <?php echo mo_wc_sl("After Registration Form");?>
                        </div>
                        <input type="checkbox"  /><br>
                        <span class="mo_openid_checkbox_checkmark_disable"></span>
                        <div class="mo_openid_wca_box">
        ...
        <br><br>
        <div class="mo_openid_highlight">
        <h3 style="margin-left: 2%;line-height: 210%;color: white;"><?php echo mo_wc_sl('BuddyPress Extended Mapping Attributes');?></h3>
    </div>
        <form>
            <br>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="submit" name="submit" value="<?php echo mo_wc_sl("Save settings");?>" class="button button-primary button-large" disabled />
                        <input type="button" name="back" onclick="goBack();" value="<?php echo mo_wc_sl("Back");?>" class="button button-primary button-large" disabled/>
                </td>
            </tr>
        </table>
        <br><br>
    ...
    <td>
        ...
        <script type="text/javascript">
            //to set heading name
            jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl('BuddyPress Add On'); ?>');
