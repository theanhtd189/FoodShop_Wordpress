<?php
function mo_wc_select_comment_disp(){
?>
    ...
    <div class="mo_openid_table_layout">
        <form id="comment_display" name="comment_display" method="post" action="" >
            ...
            <table id="disp_opt" class="mo_openid_display_table">
                <tr>
                    <td>
                        <?php echo mo_wc_sl('Select the options where you want to add social comments');?>.
                    </td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td>
                        <label class="mo_openid_checkbox_container"> <b><?php echo mo_wc_sl('Blog Post');?></b>
                ...
                <tr>
                    <td>
                        <label class="mo_openid_checkbox_container"> <b><?php echo mo_wc_sl('Static Pages');?></b>
