<?php
function mo_wc_select_comment_app(){
    ?>
    <div class="mo_openid_table_layout">
        <table class="mo_openid_display_table">
            <tr>
                <td colspan="2">
                    <br>
                    <b><?php echo mo_wc_sl('Select applications to add Social Comments. These commenting applications will be added to your blog post pages at the location of your comments.');?></b>
                </td>
            </tr>
        </table>
        ...
        <table id="sel_app">
            <tr>
                <td>
                    <h3><?php echo mo_wc_sl('Select Applications');?></h3>
                    <?php echo mo_wc_sl('If none of the below are selected, default WordPress comments will only be visible. Only selecting Default WordPress Comments will not result in any changes');?>.
                </td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            </tr>
            <td>
                ...
                <label class="mo_openid_checkbox_container"> <b><?php echo mo_wc_sl('Default WordPress Comments');?></b>
            ...
            <tr>
                <td>
                    ...
                    <label class="mo_openid_checkbox_container"> <b><?php echo mo_wc_sl('Facebook Comments');?></b>
             ...
             <tr>
                <td>
                    ...
                    <label class="mo_openid_checkbox_container"> <b><?php echo mo_wc_sl('Disqus Comments');?></b>
        ...
        <div><br/> <br/>
            <input type="submit" name="submit" value="<?php echo mo_wc_sl('Save');?>" style="width:150px;text-shadow: none;background-color:#0867b2;color:white;box-shadow:none;" class="button button-primary button-large" />

        </div>
        </form>
    </div>
    <script>
        jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl('Social Comments');?>');
    </script>
<?php }
