<?php
function mo_wc_select_comment_customize(){
?>
    <div class="mo_openid_table_layout">
        <form id="comment_labels" name="comment_labels" method="post" action="" >
            ...
            <br/><table class="mo_openid_display_table" style="width: 70%">
                <tr>
                    <td><b><?php echo mo_wc_sl('Comment Section Heading');?>:</b></td>
                ...
                <tr>
                    <td><b><?php echo mo_wc_sl('Comments - Default Label');?>:</b></td>
                ...
                <tr>
                    <td><b><?php echo mo_wc_sl('Comments - Facebook Label');?>:</b></td>
                ...
                <tr>
                    <td><b><?php echo mo_wc_sl('Comments - Disqus Label');?>:</b></td>
                ...
                <tr>
                    <td colspan="2"><br /><input type="submit" name="submit" value="<?php echo mo_wc_sl('Save');?>" style="width:100px;" class="button button-primary button-large" />
                    </td>
                </tr>
            </table>
        </form>
    ...
    <script>
        jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl('Customize Text For Social Comment Labels');?>');
    </script>
<?php  }