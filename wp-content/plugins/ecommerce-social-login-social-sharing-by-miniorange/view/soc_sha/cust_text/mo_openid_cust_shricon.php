<?php
function mo_wc_openid_customize_icons(){
    ?>
    ...
    <div class="mo_openid_table_layout">
        ...
        <div style="width: 100%;">
            <table style="width: 100%">
                <tr>
                    <td>
                        <h3><?php echo mo_wc_sl('Customize Sharing Icons');?></h3>
                        <p style="font-size: 17px"><?php echo mo_wc_sl('Customize shape, size and background for sharing icons');?></p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table style="width=100%">
                            <tr >
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%"><?php echo mo_wc_sl('Shape');?></td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%"><?php echo mo_wc_sl('Theme');?></td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 25%"><?php echo mo_wc_sl('Space between Icons');?></td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%"><?php echo mo_wc_sl('Size of Icons');?></td>
                            </tr>
...
<!--                                    </select>-->
                                ...
                                <td style=" width=30%">
                                 ...
                                 <br>
                                    <label class="mo-openid-radio-container"><?php echo mo_wc_sl('No background');?>*
                            ...
                            <tr>
                               <td colspan="4" class="mo_openid_note_style" style="width: 328%; padding: 10px;"><b>*<?php echo mo_wc_sl('NOTE');?>:</b> <?php echo mo_wc_sl('Custom background: This will change the background color of share icons');?>.<br> <?php echo mo_wc_sl('No background:This will remove the background color of share icons');?>.</td>
                            </tr>

                            <tr>
                                <td colspan="4">
                                    <br><b><?php echo mo_wc_sl('Preview');?> : </b><br/>
                                    <div>
                                        <?php
            ...
            <br>
            <h3><?php echo mo_wc_sl('Customize Text For Social Share Icons');?></h3>
            <style>
                .share_text{
                    font-size: 15px;
            ...
            <hr>
                    <b class="share_text"><?php echo mo_wc_sl('Select color for share heading');?>:</b>
            ...
            <br><br>
                    <b class="share_text" ><?php echo mo_wc_sl('Enter text to show above share widget');?>:</b>
            ...
            <br><br>
                    <b class="share_text" ><?php echo mo_wc_sl('Enter your twitter Username (without @)');?>:</b>
            ...
            <br><br>
                    ...
                    <b class="share_text"><?php echo mo_wc_sl('Enter the Email subject (email share)');?>:</b>
            ...
            <br><br>
                    ...
                    <b class="share_text"><?php echo mo_wc_sl('Enter the Email body (add ##url## to place the URL)');?>:</b>
    ...
    <script type="text/javascript">
        ...
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl('Customize text for Social Share Icons');?>');
    </script>
