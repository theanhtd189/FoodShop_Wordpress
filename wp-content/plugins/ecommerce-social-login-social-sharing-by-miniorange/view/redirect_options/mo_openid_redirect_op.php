<?php
function mo_wc_openid_redirect_opt()
{
    ?>
    <form id="mo_openid_redirect" name="redirect" method="post" action="">
        ...
        <div class="mo_openid_table_layout">
            <b><h3><?php echo mo_wc_sl('Redirect URL after login:');?></h3></b>
            <table style="width: 100%;">
                <tr>
                    <td colspan="2">
                        <label class="mo-openid-radio-container"><b>*</b><?php echo mo_wc_sl('Same page where user logged in');?>
                ...
                <tr>
                    <td>
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Homepage');?>
                ...
                <tr>
                    <td colspan="2">
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Account dashboard');?>
                ...
                <tr>
                    <td style="width: 30%">
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Custom URL');?>
                ...
                <tr>
                    <td style="width: 30%">
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Relative URL');?>
                ...
                <tr>
                    <td colspan="2">
                        <br>
                        <label style="cursor: auto" class="mo_openid_note_style"><?php echo mo_wc_sl('*NOTE: If you login through WordPress default login page after login you will be redirected to Homepage');?>.</label>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <label class="mo_openid_checkbox_container"><b><?php echo mo_wc_sl('Redirect URL after logout:');?></b>
                ...
                <tr>
                    <td>
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Home Page');?>
                ...
                <tr  colspan="2">
                    <td>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Current Page');?>
                ...
                <tr  colspan="2">
                    <td>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Login Page');?>
                ...
                <tr>
                    <td>
                        <br><br>
                        <label class="mo_openid_checkbox_container_disable"> <b>  <?php echo mo_wc_sl("Enable Registration Redirection");?></b><a style="left: 1%; position: relative; text-decoration: none" class="mo-openid-premium" href="<?php echo add_query_arg( array('tab' => 'licensing_plans'), $_SERVER['REQUEST_URI'] ); ?>"><?php echo mo_wc_sl('PRO');?></a>
                ...
                <tr>
                    <td colspan="2">
                        <label class="mo-openid-radio-container_disable">
                            <input type="radio" /><b>*</b><?php echo mo_wc_sl("Same page where user logged in");?>
                            <span class="mo-openid-radio-checkmark"></span></label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <label class="mo-openid-radio-container_disable">
                            <input type="radio" /><?php echo mo_wc_sl("Homepage");?>
                            <span class="mo-openid-radio-checkmark"></span></label>
                    </td>
                ...
                <tr>
                    <td colspan="2">
                        <label class="mo-openid-radio-container_disable">
                            <input type="radio" /><?php echo mo_wc_sl("Account dashboard");?>
                            <span class="mo-openid-radio-checkmark"></span></label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 30%">
                        <label class="mo-openid-radio-container_disable"><?php echo mo_wc_sl("Custom URL");?>
                            <input type="radio" />
                            <span class="mo-openid-radio-checkmark"></span></label>
                    </td>
                ...
                <tr>
                    <td style="width: 30%">
                        <label class="mo-openid-radio-container_disable">
                            <input type="radio" /><?php echo mo_wc_sl("Relative URL");?>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="mo-openid-radio-checkmark"></span></label>
                    </td>
                    <td style="width: 60%">
                ...
                <tr>
                    <td colspan="2"><br/><b><input type="submit" name="submit" value="<?php echo mo_wc_sl('Save');?>" style="width:150px;text-shadow: none;background-color:#0867b2;color:white;box-shadow:none;" class="button button-primary button-large" /></b>
                    </td>
                </tr>
            </table>
        </div>
        <script>
            //to set heading name
            jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl('Redirection Options');?>');
