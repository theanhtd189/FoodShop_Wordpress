<?php
function mo_wc_openid_email_notification(){
    ?>
    <div class="mo_openid_table_layout">
        <br/><div>
            ...
            <div class="mo_openid_highlight">
                <h3 style="margin-left: 1%;line-height: 210%;color: white;" id="mo_openid_send_email_admin_collapse" onclick="show_disable_send_email_admin(this.id)"><?php echo mo_wc_sl('Send mail to Admin');?><span class="dashicons dashicons-arrow-up toggle-div1" ></span></h3>
                <style>
                    .toggle-div1{
                        float:inherit;
                        font-size:1.5em;
            ...
            <div id="mo_send_email_admin">
                <b class="mo_openid_note_style"><?php echo mo_wc_sl('*NOTE: This feature requires SMTP to be setup.');?></b><br/>
                <label class="mo_openid_checkbox_container_disable"><b><?php echo mo_wc_sl('Enable Email Notification to Admin - on User Registration*');?></b>
                    <input type="checkbox"  />
                    <span class="mo_openid_checkbox_checkmark_disable"></span>
                </label>
                <b><?php echo mo_wc_sl('If you want to send Email Notification to multiple admins, enter emails of all admins here:')?></b><br><br><?php echo '(If left empty only administrator gets email)';?>
                ...
                <br />
                <br><b><?php echo mo_wc_sl('Email Subject:');?></b>
            ...
            <div class="mo_openid_highlight">
                <h3 style="margin-left: 1%;line-height: 210%;color: white;" id="mo_openid_send_email_user_collapse" onclick="show_disable_send_email_user(this.id)"><?php echo mo_wc_sl('Send mail to User');?><span class="dashicons dashicons-arrow-up toggle-div1" ></span></h3>
                <style>
                    .toggle-div1{
                        float:inherit;
                        font-size:1.5em;
            ...
            <div  id="mo_send_email_user">
                ...
                <b class="mo_openid_note_style"><?php echo mo_wc_sl('*NOTE: This feature requires SMTP to be setup');?>.</b><br/>
                <label class="mo_openid_checkbox_container_disable"><b><?php echo mo_wc_sl('Email Notification to User on User Registration');?>*</b>
                    <input type="checkbox"  />
                    <span class="mo_openid_checkbox_checkmark_disable"></span>
                </label>

              <b><?php echo mo_wc_sl('Email Subject:');?></b>
                ...
                wp_editor( $content, $editor_id ,$editor_height);
                ?>
                <input disabled type="button" name="submit" value="<?php echo mo_wc_sl('Save');?>" style="width:100px;" class="button button-primary button-large" />
                <br><br>
            </div>
            </form>
        </div>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl('Email Notification');?>');
