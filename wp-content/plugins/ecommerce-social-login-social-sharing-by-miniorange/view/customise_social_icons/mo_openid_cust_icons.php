...
function mo_wc_openid_customise_social_icons(){
    ?><br/>
            ...
            <div style="float: left;width: 55%;">
                <div style="width: 100%;">
                    <div style="float:left;width:50%;">
                        <label style="font-size: 1.2em;"><b><?php echo mo_wc_sl('Shape');?></b><br></label>
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Round');?>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Rounded Edges');?>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Square');?>
                            ...
                            <span class="mo-openid-radio-checkmark"></span></label>
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Long Button');?>
                    ...
                    <div style="float: right; width: 50%;">
                        <label style="font-size: 1.2em;"><b><?php echo mo_wc_sl('Theme');?></b><br></label>
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Default');?>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_wc_sl('Custom background*');?>
                        ...
                        <input type="color" id="mo_login_icon_custom_color"  style="width:135px;" name="mo_login_icon_custom_color"  value="<?php echo esc_attr(get_option('mo_login_icon_custom_color'))?>" onchange="moLoginPreview(setSizeOfIcons(), setLoginTheme(),'custom',document.getElementById('mo_login_icon_custom_color').value,document.getElementById('mo_login_icon_space').value,document.getElementById('mo_login_icon_custom_boundary').value)"><br><br>
                    </div>

                </div>
                <div style="width: 85%; float: left" class="mo_openid_note_style"><strong><?php echo mo_wc_sl('*Custom background:');?></strong> If you want to enter the <strong>HEX</strong> code in google chrome, click RGB panel at the bottom and select <strong>HEX</strong>.<a style="cursor: pointer;" onclick="mo_custom_color_ss()">CLICK HERE<center><img id="mo_custom_color_img" style="display: none;" src="<?php echo plugin_dir_url(dirname(__DIR__)) . 'includes/images/custom_color.png'; ?> "></center></a></div>

<!--                <div style="width: 85%; float: left" class="mo_openid_note_style"><strong>--><?php //echo mo_wc_sl('*Custom background:');?><!--</strong> --><?php //echo mo_wc_sl('This will change the background color of login icons');?><!--.</div>-->
                <div style="width: 100%; float: left">
                    <div style="float:left;width:50%; margin-top: 5%">
                        <label style="font-size: 1.2em;"><b><?php echo mo_wc_sl('Size of Icons');?></b></label>
                        <div id="long_button_size">
                            <?php echo mo_wc_sl('Width:');?> &nbsp;<input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 16%;margin-bottom: 3px" id="mo_login_icon_width" onkeyup="moLoginWidthValidate(this)" name="mo_login_icon_custom_width" type="text" value="<?php echo esc_attr(get_option('mo_login_icon_custom_width'))?>" >
                            ...
                            <?php echo mo_wc_sl('Height:');?>&nbsp;<input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 16%;margin-bottom: 3px" id="mo_login_icon_height" onkeyup="moLoginHeightValidate(this)" name="mo_login_icon_custom_height" type="text" value="<?php echo esc_attr(get_option('mo_login_icon_custom_height'))?>" >
                            <input id="mo_login_height_plus" type="button" value="+" onmouseup="moLoginPreview(document.getElementById('mo_login_icon_width').value,setLoginTheme(),setLoginCustomTheme(),document.getElementById('mo_login_icon_custom_color').value,document.getElementById('mo_login_icon_space').value,document.getElementById('mo_login_icon_height').value,document.getElementById('mo_login_icon_custom_boundary').value)" >
                            <input id="mo_login_height_minus" type="button" value="-" onmouseup="moLoginPreview(document.getElementById('mo_login_icon_width').value,setLoginTheme(),setLoginCustomTheme(),document.getElementById('mo_login_icon_custom_color').value,document.getElementById('mo_login_icon_space').value,document.getElementById('mo_login_icon_height').value,document.getElementById('mo_login_icon_custom_boundary').value)" ><br/>
                            <?php echo mo_wc_sl('Curve:');?>&nbsp;&nbsp;<input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 16%;margin-bottom: 3px" id="mo_login_icon_custom_boundary" onkeyup="moLoginBoundaryValidate(this)" name="mo_login_icon_custom_boundary" type="text" value="<?php echo esc_attr(get_option('mo_login_icon_custom_boundary'))?>" />
                    ...
                    <div style="width: 50%;float: right;margin-top: 5%">
                        <label style="font-size: 1.2em;"><b><?php echo mo_wc_sl('Space between Icons');?></b></label><br/>
                ...
                <div style="width: 100%; float: left">
                    <br><hr>
                    <label class="mo_openid_checkbox_container"><?php echo mo_wc_sl('Load Fontawesome files');?>
                    ...
                    <label class="mo_openid_checkbox_container"><?php echo mo_wc_sl('Load bootstrap files');?>
                    ...
                    <h4 style="font-size: 1.2em"><?php echo mo_wc_sl('Customize Text For Social Login Buttons / Icons');?></h4>
                    <div style="width: 100%">
                        <div style="width: 40%; float: left">
                            <label class="mo_openid_fix_fontsize"><?php echo mo_wc_sl('Select color for customize text:');?></label>
                        </div>
                        <div style="width: 60%; float: right;">
                            <input type="color" id="mo_openid_table_textbox"  style="width:135px;" name="mo_login_openid_login_widget_customize_textcolor"  value="<?php echo esc_attr(get_option('mo_login_openid_login_widget_customize_textcolor'))?>" >
...
<!--                            <input id="mo_openid_table_textbox" name="mo_login_openid_login_widget_customize_textcolor"  class="color" value="--><?php //echo esc_attr(get_option('mo_login_openid_login_widget_customize_textcolor'))?><!--" >-->
                    ...
                    <div style="width: 100%; margin-top: 12%">
                        <div style="width: 100%;">
                            <label class="mo_openid_fix_fontsize"><?php echo mo_wc_sl('Enter text to show above login widget:');?></label>
                    ...
                    <div style="width: 100%; margin-top: 2%" id="long_button_text">
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize"><?php echo mo_wc_sl('Enter text to show on your login buttons:');?></label>
                ...
                <div style="width: 100%; float: left">
                    <br><hr>
                    <h4 style="font-size: 1.2em"><?php echo mo_wc_sl('Customize Text to show user after Login');?></h4>
                    <div style="width: 100%;">
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize"><?php echo mo_wc_sl('Enter text to show before the logout link. Use ##username## to display current username:');?></label> <br>
                    ...
                    <div style="width: 100%; margin-top: 15%" id="long_button_text">
                        <br>
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize"><?php echo mo_wc_sl('Enter text to show as logout link:');?></label>
                    ...
                    <div style="margin-top: 8%; margin-bottom: 2%">
                        <b><input type="submit" name="submit" value="<?php echo mo_wc_sl('Save');?>" style="width:150px;background-color:#0867b2;color:white;box-shadow:none;text-shadow: none;" class="button button-primary button-large" /></b>
                    </div>
                </div>
            </div>
            ...
            <div style="border: 1px solid black; min-width: 200px; min-height: 200px; padding-top: 8%; padding-bottom: 5%">
                    ...
                    foreach ($app_pos as $active_app)
                    {
                        if(get_option('mo_openid_'.$active_app.'_enable')){
                            ...
                            if($active_app=='facebook')
                            {
                                $count_app++;
                                ?>
                                <img class="mo_login_icon_preview" id="mo_login_icon_preview_facebook" src="<?php echo mo_wc_plugin_url.'/facebook.png'?>" />
                                ...
                                $count_app++;
                                ?>
                                <img class="mo_login_icon_preview" id="mo_login_icon_preview_google" src="<?php echo mo_wc_plugin_url.'/google.png'?>" />
                                ...
                                $count_app++;
                                ?>
                                <img class="mo_login_icon_preview" id="mo_login_icon_preview_<?php echo $active_app ?>" src="<?php echo mo_wc_plugin_url.'/'.$active_app.'.png'?>" />
                ...
                <div style="border: 1px solid"><br>
                    <b style="font-size: 17px;"><?php echo mo_wc_sl('Custom CSS');?> <a style="left: 1%; position: relative; text-decoration: none" class="mo-openid-premium" href="<?php echo add_query_arg( array('tab' => 'licensing_plans'), $_SERVER['REQUEST_URI'] ); ?>"><?php echo mo_wc_sl('PRO');?></a></b>
    ...
    <script>
        function mo_custom_color_ss(){
            var x = document.getElementById("mo_custom_color_img").style.display;
            if(x == "none")
                document.getElementById("mo_custom_color_img").style.display= "block";
            else
                document.getElementById("mo_custom_color_img").style.display= "none";

        }
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo mo_wc_sl("Customize Login Icons"); ?>');
        ...
        function moLoginPreview(t,r,l,p,n,h,k){
            if(l == 'default'){
                ...
                if(r == 'longbutton'){
                    ...
                    jQuery("."+a).css("background-color","#"+p);
