...
class vkontakte
{
    ...
    function mo_wc_openid_get_app_code()
    {
        ...
        $social_app_redirect_uri= wc_get_social_app_redirect_uri('vkontakte');
    ...
    function mo_wc_openid_get_access_token()
    {
        ...
        $access_token_json_output = mo_wc_openid_get_access_token($postData, $access_token_uri,'vkontakte');
        ...
        $profile_json_output = mo_wc_openid_get_social_app_data($access_token, $profile_url,'vkontakte');
