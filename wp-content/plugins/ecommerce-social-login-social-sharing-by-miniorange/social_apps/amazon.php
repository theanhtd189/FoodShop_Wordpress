...
class amazon
{
    ...
    public function __construct() {
        ...
        $this->instructions="Go to <a href=\"http://login.amazon.com\" target=\"_blank\">http://login.amazon.com</a> and sign in with your amazon developer account and select App Console.##On the page, Click on the <strong>Create a New Security Profile</strong> button and enter a <strong>Name, Description, and Privacy Notice URL</strong> for your app. Click on Save.##Expand the <strong>Web Settings</strong> section.##Enter <b><code id='12'>".mo_wc_get_permalink('amazon')."</code><i style= \"width: 11px;height: 9px;padding-left:2px;padding-top:3px\" class=\"mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip\" onclick=\"copyToClipboard(this, '#12', '#shortcode_url_copy')\"><span id=\"shortcode_url_copy\" class=\"mo_copytooltiptext\">Copy to Clipboard</span></i></b> in the <strong>Allowed Return URLs</strong>##  Copy the Client Id and Client Secret from the Web Settings and Paste them into the fields above. ## Click on the Save settings button to Click on the Save and Test Configuration button. ## If you are facing any problem drop a mail on socialloginsupport@xecurify.com.";
    }
    ...
    function mo_wc_openid_get_app_code()
    {
        ...
        $social_app_redirect_uri= wc_get_social_app_redirect_uri('amazon');
    ...
    function mo_wc_openid_get_access_token()
    {
        ...
        $access_token_json_output = mo_wc_openid_get_access_token($postData, $access_token_uri,'amazon');
