...
class yahoo
{
    ...
    public function __construct()
    {
        if (get_option('permalink_structure') !== "") {
            ...
            $this->instructions = "Go to <a href=\"https://developer.yahoo.com\" target=\"_blank\">https://developer.yahoo.com</a> Sign in with your yahoo account and select Apps from the menubar.##On the page, Click on the <strong>Create an App</strong> button.##Enter <strong>Application Name</strong> and select <strong>Application Type</strong> as <strong>Web Application</strong>.##Enter <b><code id='13'>" . get_option('siteurl') . "</code><i style= \"width: 11px;height: 9px;padding-left:2px;padding-top:3px\" class=\"mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip\" onclick=\"copyToClipboard(this, '#13', '#shortcode_url_copy')\"><span id=\"shortcode_url_copy\" class=\"mo_copytooltiptext\">Copy to Clipboard</span></i></b> in the <strong>Home Page URL</strong>.##Enter <b><code id='14'>" . mo_wc_get_permalink('yahoo') . "</code><i style= \"width: 11px;height: 9px;padding-left:2px;padding-top:3px\" class=\"mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip\" onclick=\"copyToClipboard(this, '#14', '#shortcode_url1_copy')\"><span id=\"shortcode_url1_copy\" class=\"mo_copytooltiptext\">Copy to Clipboard</span></i></b></b> in <b>Callback Domain</b>##Select all <b>API Permissions</b>.##Click on <strong>Create App</strong>.##Copy the <b>Client ID</b> and <b>Client Secret</b> from this page and Paste them into the fields above.##Keep <b>Scope</b> blank. ## Click on the <strong> Save & Test Configuration button </strong>. ##Let us know if you require any help in configuring <strong>miniOrnage Pre Configured App,</strong><br>Please Contact us at <a href=\'mailto:socialloginfeedback@xecurify.com'>socialloginfeedback@xecurify.com</a>";
        }
        else
    ...
    function mo_wc_openid_get_app_code()
    {
        ...
        $social_app_redirect_uri= wc_get_social_app_redirect_uri('yahoo');
    ...
    function mo_wc_openid_get_access_token()
    {
        ...
        $access_token_json_output = mo_wc_openid_get_access_token($postData, $access_token_uri,'yahoo');
        ...
        $profile_json_output = mo_wc_openid_get_social_app_data($access_token, $profile_url,'yahoo');
