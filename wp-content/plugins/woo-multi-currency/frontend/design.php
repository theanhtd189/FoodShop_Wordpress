                    ...
                    <div class="wmc-currency <?php echo esc_attr( $selected ) ?>"
						...
						switch ( $this->settings->get_sidebar_style() ) {
							...
							case 4:
								...
								break;
							default:
								$currency_code = esc_html( $currency_name[ $k ] );

						}
						?>
                        <span class="wmc-currency-symbol"><?php echo $symbol; ?></span>
						<?php
						if ( $selected ) {
							?>
                            <span class="wmc-active-title"><?php echo $currency_code; ?></span>
							<?php
						} else {
							?>
                            <a <?php echo WOOMULTI_CURRENCY_F_Data::get_rel_nofollow(); ?>
                                    href="<?php echo esc_url( $link ) ?>"><?php echo $currency_code; ?></a>
							<?php
						}
						?>
                    </div>
